...
const ExperimentoEvento = () => {
  ...
  // Función para continuar el cuestionario
  const continuarCuestionario = () => {
    // Redirigir a la siguiente etapa o realizar otra acción
    navegar('/siguiente-etapa'); // Asegúrate de que esta ruta exista en tu aplicación
  };
    ...
    <div className="experimento-evento-container">
      ...
      {mostrarResumen && (
        <Resumen
          ...
          continuarQuiz={continuarCuestionario}
        />
      )}
    </div>
  );
