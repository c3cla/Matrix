...
export const Pelotas = () => {
  ...
  // Nueva función para continuar a la siguiente etapa (puedes ajustarla según tus necesidades)
  const continuarQuiz = () => {
    console.log("Continuar a la siguiente etapa");
  };
  ...
  return (
    <div>
      {/* Botón modo daltónico y Barra de progreso */}
        ...
        <div className="contenedor-problema">
                ...
                {modoDaltonico &&
                  coloresDisponibles.map((color) => (
                    <pattern
                      ...
                      height="10"
                    >
                      {patronesDaltonicos[color] === "lineas-diagonal" && (
                        <>
                      ...
                      {patronesDaltonicos[color] === "puntos" && (
                        <>
                          <rect width="10" height="10" fill="white" />
                          <circle
                            cx="5"
                      ...
                      {patronesDaltonicos[color] === "lineascruzadas" && (
                        <>
                          <rect width="10" height="10" fill="white" />
                          <line
                            x1="0"
                      ...
                      {patronesDaltonicos[color] === "lineas-horizontal" && (
                        <>
                          <rect width="10" height="10" fill="white" />
                          <line
                            x1="0"
                      ...
                      {patronesDaltonicos[color] === "lineas-vertical" && (
                        <>
                          <rect width="10" height="10" fill="white" />
                          <line
                            x1="5"
                      ...
                      {patronesDaltonicos[color] === "rejilla" && (
                        <>
                          <rect width="10" height="10" fill="white" />
                          <line
                            x1="0"
          ...
          <div className="opciones">
            {opciones.map((opcion, index) => {
              // Crear la expresión LaTeX para la opción
              let latexExpression = "";
              if (opcion.includes("/")) {
